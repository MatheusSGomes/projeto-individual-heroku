                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('products.edit', $product->id) }}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-6">
                              <input id="user_id" type="text" class="form-control @error('user_id') is-invalid @enderror" name="user_id" value="{{ $product->user_id }}" readonly disabled autocomplete="user_id" autofocus>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-6">
                              <input id="category_id" type="text" class="form-control @error('category_id') is-invalid @enderror" name="category_id" value="{{ $product->category_id }}" readonly disabled autocomplete="category_id" autofocus>
